        ...
        while not (frames.qsize() == 0 and recording_flag == False):
            if(not frames.empty()):
                ...
                if len(markers[0]) > 0:
                    ...
                    #cropping
                    pts1 = numpy.float32([
                        [0, marker_height + (1 * mm2px_height)], # marker has 1mm padding bottom
                        [marker_width,marker_height + (1 * mm2px_height)],
                        [0, marker_height + px_screen_height],
                        [marker_width,  marker_height + px_screen_height]
                    ])
 
                    pts2 = numpy.float32([[0,0],[marker_width,0],[0,self.screen_height * mm2px_height],[marker_width,self.screen_height * mm2px_height]])
                    ...
                    self.current_frame = cv2.resize(self.current_frame, (620, 1100))
